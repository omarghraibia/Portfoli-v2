document.addEventListener('DOMContentLoaded', () => {
  ...
  const dataProjets = {
    "allo-kine": {
      ...
      gallery: ["assets/allokine/Accueil.png", "assets/allokine/avis.png"],
      codeLink: "https://github.com/omarghraibia/allokine",
      liveLink: "https://allokine.vercel.app/"
    },
    "inetum": {
      title: "Inetum",
      description: "Site éco-conçu pour vulgariser les métiers du numérique.",
      technologies: ["HTML5", "CSS3", "Git", "Green IT"],
      gallery: ["assets/inetum/accueil.webp", "assets/inetum/candidater.webp"],
    ...
    "morpion": {
      ...
      gallery: ["assets/morpion/acceuil 1v1.png", "assets/morpion/fin partie 1V1.png"],
